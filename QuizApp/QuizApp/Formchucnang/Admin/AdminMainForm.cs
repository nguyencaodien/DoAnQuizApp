...
namespace QuizApp.Forms.Admin
{
    public partial class AdminMainForm : Form
    {
        ...
        private void LoadStatistics()
        {
            ...
            int totalAssignments = QuizAssignmentManager.Instance.GetAssignmentCount();
            ...
            CreateStatCard(statsPanel, "Phân công bài thi", totalAssignments.ToString(), 520, 220, Color.FromArgb(26, 188, 156));
